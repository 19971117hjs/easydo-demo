...
exports.default = {
  ...
  methods: {
    ...
    eyedropperClick: function eyedropperClick() {
      var _this = this;
    ...
    filterValid: function filterValid(_colors) {
      var _this2 = this;

      var colors = Array.isArray(_colors) ? _colors : [];
      return colors.filter(function (c) {
        return _this2.isValidHex(c);
      });
    },
    handlePreset: function handlePreset(c, i) {
  ...
  return _c(
    ...
    [
      ...
      !_vm.disableFields
        ...
        : _vm._e(),
      _vm._v(" "),
      _vm.eyeDropperEnabled
        ? _c("div", { staticClass: "vc-sketch-eyedropper-container" }, [
            _c(
              "button",
              { staticClass: "button", on: { click: _vm.eyedropperClick } },
              [
                _c(
                  "div",
                  { staticClass: "svg-icon color-dropper color-dropper-svg" },
                  [
                    _c(
                      "svg",
                      {
      ...
      !_vm.disablePresets
        ? _c("div", [
            _c(
              ...
              {
                class: {
                  deleting: _vm.isShiftPressed,
                  "vc-sketch-presets": true
                },
                attrs: {
                  role: "group",
                  "aria-label":
              ...
              [
                _vm._l(_vm.colorPalette, function(c, i) {
                  return [
                    !_vm.isTransparent(c)
                      ? _c("div", {
                          key: i + c,
                ...
                _c(
                  ...
                  {
                    key: "addNew",
                    staticClass: "vc-sketch-presets-color addNew special",
                    attrs: { "aria-label": "Add new" },
                    on: {
                      click: function($event) {
                        return _vm.handlePreset("addNew")
                      }
                    }
                  },
                  [_vm._v("\n            +\n          ")]
            ...
            _vm._v(" "),
            _vm.colorPalette.length > 0
              ? _c("div", { staticClass: "hintRemove" }, [
                  _vm._v("\n        " + _vm._s(_vm.hintRemove) + "\n      ")
                ])
              : _vm._e()
          ])
        : _vm._e()
